...
This project:
- Builds GrapheneOS on an AWS EC2 Spot instance;
...
With reproducible builds, you can have more transparency and guarantees that the official GrapheneOS builds come from the same source code that they maintain/publish.
...
### Pending work
- [ ] Adapt the scripts to deal with multiple devices in a robust way;
