...
- Hashes of the partitions in the official OTA that was tested/compared with my reproduced build. These hashes are compared with the target hashes of the incrementals/deltas to see if they are trustworthy too:
  - `https://gos-reproducibility-reports.s3.us-east-1.amazonaws.com/additional-comparisons${PIXEL_CODENAME}-${GOS_BUILD_NUMBER}.txt`. 
    - For example: https://gos-reproducibility-reports.s3.us-east-1.amazonaws.com/additional-comparisonshusky-2024121200.txt
