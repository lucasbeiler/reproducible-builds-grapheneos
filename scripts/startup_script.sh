...
# Uncompress my scripts, which I had to compress due to cloud-init 32KB limit.
...
# Avoid needing to set a new root password.
...
apt --install-recommends install -y python3-protobuf diffoscope e2fsprogs python3-pip golang binwalk device-tree-compiler awscli liblzma-dev lz4 binutils-aarch64-linux-gnu xxd android-sdk-libsparse-utils erofs-utils
